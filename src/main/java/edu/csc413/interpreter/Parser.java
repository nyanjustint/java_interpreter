...
public class Parser {
    ...
    public Statement createForStatement(
        ...
        // TODO: Implement.
        return new ForStatement(loopVariableName, parseExpression(rangeStartAsString),
                parseExpression(rangeEndAsString), bodyStatements);
    }
    ...
    public Statement createReturnStatement(String expressionAsString) {
        // TODO: Implement.
        Expression temp = parseExpression(expressionAsString);
    ...
    public Expression createFunctionCallExpression(String functionName, List<String> parameterValuesAsStrings) {
        ...
        int i = 0;
        while(i<parameterValuesAsStrings.size()){
            temp.add(parseExpression(parameterValuesAsStrings.get(i)));
            i++;
        }
        return new FunctionCallExpression(functionName, temp);
    }
